...
class phase_analysis_stage:
    ...
    def __init__(self, initial_data):
        ...
        components_init_data = [
            self.create_initial_data(i, initial_data) 
            for i in range(self.num_components)
        ]

        self.components = [
            phase_analysis(components_init_data[i])
            for i in range(self.num_components)
        ]
    ...
    def create_initial_data(self, component_index, stage_initial_data):
        stage_initial_data["id"] = "Fourier Phase [" + str(component_index) + "]"
        return stage_initial_data